...
interface MeadRecipeControllerPaths {
  getAll: string;
}
...
export class JavaServerConfig {
  ...
  public meadRecipeController: MeadRecipeControllerPaths;
...
export class AppConfig implements AppConfigData {
  ...
  constructor(data: AppConfigData) {
    ...
    this.javaServer = new JavaServerConfig(
      ...
      data.javaServer.meadRecipeController,
  ...
  getMeadRecipeGetAllPath(): string {
    return this.javaServer.meadRecipeController.getAll;
  }
